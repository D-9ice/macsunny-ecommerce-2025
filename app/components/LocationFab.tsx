...
export default function LocationFab() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-[192px] right-5 w-16 h-16 rounded-full animate-spin-slow z-40">
      ...
      <button
        ...
        className="fixed bottom-[192px] right-5 bg-white hover:bg-gray-50 text-gray-800 p-4 rounded-full shadow-lg z-50 transition focus:outline-none focus:ring-2 focus:ring-blue-400 w-16 h-16 flex items-center justify-center border-2 border-gray-200"
      ...
      {/* Animated Pop-up */}
      {open && (
        <div className="fixed bottom-[216px] right-5 z-[60] w-64 rounded-xl force-bg-white p-4 shadow-2xl border-2 border-blue-400 animate-fade-in-up">
